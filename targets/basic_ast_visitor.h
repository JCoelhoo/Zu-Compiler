// $Id: basic_ast_visitor.h,v 1.7 2016/04/11 21:26:50 ist177983 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_ret_node(zu::ret_node * const node, int lvl) = 0;
  virtual void do_cont_node(zu::cont_node * const node, int lvl) = 0;
  ...
  virtual void do_function_impl_node(zu::function_impl_node * const node, int lvl) = 0;
  ...
  virtual void do_declaration_node(zu::declaration_node * const node, int lvl) = 0;
